...
public class CalculSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CalculPackage.CALCUL: {
				...
				if (result == null) result = caseInterCalc(calcul);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculPackage.INTER_CALC: {
				InterCalc interCalc = (InterCalc)theEObject;
				T result = caseInterCalc(interCalc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inter Calc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inter Calc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInterCalc(InterCalc object) {
		return null;
	}
