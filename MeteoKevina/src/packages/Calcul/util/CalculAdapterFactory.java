...
public class CalculAdapterFactory extends AdapterFactoryImpl {
	...
	protected CalculSwitch<Adapter> modelSwitch =
		new CalculSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInterCalc(InterCalc object) {
				return createInterCalcAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link packages.Calcul.Calcul <em>Calcul</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link packages.Calcul.InterCalc <em>Inter Calc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInterCalcAdapter() {
		return null;
	}
